...
public class RemoveGiftTask extends AsyncTask<Void, Void, Void> {
	...
	public RemoveGiftTask(EventActivity callingActivity, String type,
	...
	protected void onPostExecute(Void arg) {
		...
		if (result.get(0).equals("success")) {
			callingActivity.mAdapter.gf.postDelete(position);
		}
